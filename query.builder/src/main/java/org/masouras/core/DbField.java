...
import org.masouras.base.repo.loader.DbFieldAcceptedValuesRegistry;
...
final class DbField {
    ...
    DbField(BaseDbField dbF) {
        ...
        this.dbfAcceptedValues = Collections.singletonList(DbFieldAcceptedValuesRegistry.get(this.dbfNameEnum));
    }
}
