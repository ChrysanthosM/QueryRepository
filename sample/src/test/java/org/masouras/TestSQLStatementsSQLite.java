...
import org.masouras.squad.sample.sqlite.schema.structure.DbFieldValues;
import org.masouras.squad.sample.sqlite.schema.table.AutoNumberingTable;
    ...
    private void testSQLStatementsMain(boolean normalizeNames) {
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames)
                ...
                normalizeNames
                        ...
                        "Sys_EntityType AS \"Sys_Entitytype\" || 'AAA' || '1' || LTRIM(Sys_EntityType AS \"Sys_Entitytype\") " +
